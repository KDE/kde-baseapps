...
#include "quickfolder.h"

RemoteWallpaperSetter::RemoteWallpaperSetter(const KUrl &url, QuickFolder *containment)
    : QObject(containment)
{
...
{
    if (!job->error()) {
        QuickFolder *containment = static_cast<QuickFolder*>(parent());
